...
> code (auth, RBAC, seat billing, audit log, rate limiting, 240 tests) is included
> with your purchase.
>
...
| ![240 tests passing](docs/screenshots/S6-vitest-240-passed.png) | Verbatim `npm test` output — 240 passing |
...
[![Version](https://img.shields.io/badge/version-0.2.3-green)](https://github.com/verdantstack/multi-tenant-sveltekit-starter/releases)
...
- [x] Tests: **240 passing** covering auth, rate limiter, matrix, hierarchy, invite lifecycle, seat limits
...
# 3. Test
npm test               # 240 tests (uses :memory: SQLite)
