...
<p align="center">
  <a href="https://verdantstack.dev/products/multi-tenant-sveltekit-starter/">Documentation & guides →</a>
</p>
...
> code (auth, RBAC, seat billing, audit log, rate limiting, 298 tests) is included
> with your purchase.
>
...
website: https://verdantstack.dev/products/multi-tenant-sveltekit-starter/
...
| Deployment docs | ❌            | ✅ (VPS, Docker, Cloudflare, Vercel, Fly) |
| Tests           | 0–10          | 298                                       |
...
| ![298 tests passing](docs/screenshots/S6-vitest-298-passed.png)                                   | Verbatim `npm test` output — 298 passing          |

</details>

## Status

**Version**: 0.2.8 | Last Updated: 2026-09-20 | **License**: Proprietary

[![Changelog](https://img.shields.io/badge/changelog-CHANGELOG.md-blue)](CHANGELOG.md)
[![Version](https://img.shields.io/badge/version-0.2.8-green)](https://github.com/verdantstack/multi-tenant-sveltekit-starter/releases)
...
- [x] Tests: **298 passing** covering auth, rate limiter, matrix, hierarchy, invite lifecycle, seat limits
...
# 3. Test
npm test               # 298 tests (uses :memory: SQLite)
...
SQLite data is persisted in a Docker named volume. See [`docs/deployment.md`](docs/deployment.md) for full deployment options (VPS, Cloudflare Pages, Vercel, Fly.io).
...
| `docs/`                       | architecture · rbac · billing · deployment · ai-billing · license                |
