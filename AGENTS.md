...
**Status:** v0.2 — 77 tests passing, CI-verified, production-ready foundation.
...
npm test             # Run vitest suite (77 tests, :memory: SQLite)
...
- **Run:** `npm test`
- **Current count:** 77 tests across 9 suites
