...
**Status:** v0.2.2 — 204 tests passing, CI-verified, production-ready foundation.
...
npm test             # Run vitest suite (204 tests, :memory: SQLite)
...
- **Run:** `npm test`
- **Current count:** 204 tests across 9 suites
