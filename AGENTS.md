...
**Status:** v0.2.3 — 240 tests passing, CI-verified, production-ready foundation.
...
npm test             # Run vitest suite (240 tests, :memory: SQLite)
...
- **Run:** `npm test`
- **Current count:** 240 tests across 9 suites
