...
A production-shaped B2B SaaS foundation for SvelteKit. Not a tutorial, not a boilerplate — a working implementation of multi-tenancy, RBAC, seat billing, and audit logging with 240 tests.
